...
3. Open Apps Script.
4. Paste in `Code.gs`.
5. The Google Sheet ID has already been inserted into `Code.gs` (`1006JNZQ5xcDDVqMvFz6OUhz6jt_qQQPCAVSM5XU4SqU`).
6. Run `setupSheets()` once.
7. Deploy the script as a Web App.
8. Copy the deployment URL.
9. The Apps Script web app URL has already been inserted into `index.html`.
